  ...
  <body>
    ...
    <div class="album py-5 bg-light">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          if (isset($_POST['cari'])) {
              $cari = $_POST['cari'];
              $query_produk = mysqli_query($koneksi, "select * from produk where id_produk = '$cari' or nama_produk like '%$cari%' or harga like '%$cari%'");
          }
          else{
          ...
          <div class="col">
            <div class="card shadow-sm">
                <img src="../images/foto_produk/<?=$data_produk['foto_produk']?>" class="bd-placeholder-img card-img-top" width="100px" height="600px" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
