...
<body>
    ...
    <div class="card mb-3" style="max-width: 100%;">
        <div class="row g-0">
            <div class="col-md-4">
            <img src="../images/foto_produk/<?=$data_produk['foto_produk']?>" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
            <form action="insert_cart.php?" method="POST">
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        ...
                        <tr>
                            <td colspan="2"><input type="submit" class="btn btn-success" value="Beli Sekarang"</td>
                        </tr>
                    </thead>
                </table>
            </form>
