            ...
            <div class="card-body">
                <form method="POST" action="proses_ubah_produk.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskripsi" row="3" placeholder="Masukkan Deskripsi Buku" required><?=$data_produk['deskripsi']?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="images/foto_produk/<?=$data_produk['foto_produk']?>" width=100>
